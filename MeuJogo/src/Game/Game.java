	...
	public static void main(String[] args ) {
		...
		do {
			...
			do {
				...
				System.out.println("O que você deseja fazer? a - Atacar / h - Usar Habilidade");
				...
				System.out.println("Seu dano acertou em cheio!");
				 ...
				 System.out.println("Dano causado foi: " + dano);
					 ...
					 System.out.println("Você não causou dano nesse combate");
				 }
				...
				if(enemy.getHp() <= 0) {
					...
					if(dano > 0) {
						...
						System.out.println("Você não recebeu dano nesse combate");
					}
